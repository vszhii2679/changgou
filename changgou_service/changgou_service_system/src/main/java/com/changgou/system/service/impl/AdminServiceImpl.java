...
public class AdminServiceImpl implements AdminService {
    ...
    public boolean login(Admin admin) {
        ...
        loginAdmin.setLoginName(admin.getLoginName());
        loginAdmin.setStatus("1");
        Admin resultAdmin = adminMapper.selectOne(loginAdmin);
        //如果查询不到用户，则登录失败
        if (resultAdmin==null){
            return false;
        }
         ...
         * hashed:加盐的密文
         */
        return BCrypt.checkpw(admin.getPassword(),resultAdmin.getPassword());
    }
